...
model = Sequential([
          ...
          Dense(32, activation='relu'), # средний слой: 32 нейрона - relu
          Dense(1, activation='tanh')   # выходн. слой: от -1 до 1 - решение нс
])
...
def play_blackjack(nn_model, bet=0, balance=1, show=True):
  """
    Нейросеть играет 1 партию в блекджек с автоматизированым дилером
  """
